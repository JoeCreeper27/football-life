...
export const EVENTS = [
  ...
  { n: '日本三球王的傳球哲學', for: 'PRO', once: true, weight: 0.22,
    cond: s => LV[s.club.lv].region === 'ASIA' || ['JP', 'KR', 'TW'].includes(s.player.nation),
    acts: ['聽完就好', '跟著練一季', '請他當長期導師'],
    gt: '「傳球不是把球送出去，是把隊友送進空檔。」你的視野從那天起變寬了',
    bt: '你把他的話當成客套，錯過了',
    g: { pas: 6, vis: 5, sta: 2, fanRep: 6 }, b: { fanRep: -2 } },
  ...
  { n: '傳奇門將的門線課', for: 'GK', once: true, weight: 0.3,
