...
export const CLUBS = {
  ...
  TPFL: [
    ...
    { n: '新竹風城', t: 2 }, { n: '台南府城', t: 3 }, { n: '宜蘭龜山', t: 4 },
  ],
  JFL: [
...
export const EVENTS = [
  ...
  { n: '街頭五人制對決', acts: ['打安全球', '正常對抗', '一個人單挑三個'], for: '*', weight: 1.2,
    cond: s => s.club.stage !== 'PRO' || LV[s.club.lv].tier <= 2,
  ...
  /* ---------- 第七類：命運與機會（觸發率低、影響大） ---------- */
  { n: '巴西足球精靈的指點', for: 'PRO', once: true, weight: 0.25,
  ...
  { n: '德國中場大師的私人課', for: 'PRO', once: true, weight: 0.25,
  ...
  { n: '阿根廷球王的邀請', for: 'PRO', once: true, weight: 0.22,
  ...
  { n: '日本三球王的邊路突破', for: 'PRO', once: true, weight: 0.22,
  ...
  { n: '義大利鏈式防守的傳人', for: 'PRO', once: true, weight: 0.22,
  ...
  { n: '義大利小將的門線課', for: 'GK', once: true, weight: 0.3,
  ...
  { n: '埃及法老的內切', for: 'PRO', once: true, weight: 0.22,
  ...
  { n: '飛翔的荷蘭人的凌空', for: 'PRO', once: true, weight: 0.2,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'NL',
  ...
  { n: '法國忍者龜的第一步', for: 'PRO', once: true, weight: 0.2,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'FR',
