...
export const EVENTS = [
  ...
  /* ---------- 第七類：命運與機會（觸發率低、影響大） ---------- */
  { n: '巴西足球精靈的指點', for: 'PRO', once: true, weight: 0.2265,
  ...
  { n: '德國中場大師的私人課', for: 'PRO', once: true, weight: 0.2265,
  ...
  { n: '阿根廷球王的邀請', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '日本三球王的邊路突破', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '義大利鏈式防守的傳人', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '巴西外星人的門前嗅覺', for: 'PRO', once: true, weight: 0.18,
    cond: s => LV[s.club.lv].region === 'SAM' || s.player.nation === 'BR',
  ...
  { n: '英國追風少年的加速課', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '英國圓月彎刀的傳中課', for: 'PRO', once: true, weight: 0.198,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'GB',
  ...
  { n: '埃及法老的內切', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '象牙海岸魔獸的對抗課', for: 'PRO', once: true, weight: 0.198,
    cond: s => LV[s.club.lv].region === 'AFR' || ['NG', 'CI'].includes(s.player.nation),
  ...
  { n: '荷蘭冰王子的冷靜', for: 'PRO', once: true, weight: 0.18,
  ...
  { n: '飛翔的荷蘭人的凌空', for: 'PRO', once: true, weight: 0.18,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'NL',
  ...
  { n: '台灣魔獸的重訓菜單', for: 'PRO', once: true, weight: 0.2265,
  ...
  { n: '土耳其火槍兵的遠射', for: 'PRO', once: true, weight: 0.18,
  ...
  { n: '台灣隊長的更衣室課', for: 'PRO', once: true, weight: 0.2265,
    cond: s => s.player.nation === 'TW' || s.player.natlPick === 'TW',
  ...
  { n: '阿根廷風之子的節奏', for: 'PRO', once: true, weight: 0.18,
  ...
  { n: '韓國三肺的跑動課', for: 'PRO', once: true, weight: 0.198,
  ...
  { n: '法國忍者龜的第一步', for: 'PRO', once: true, weight: 0.18,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'FR',
  ...
  { n: '西班牙小白的第一腳觸球', for: 'PRO', once: true, weight: 0.18,
  ...
  { n: '葡萄牙山羊的自我要求', for: 'PRO', once: true, weight: 0.162,
    cond: s => LV[s.club.lv].region === 'EUR' || s.player.nation === 'PT',
